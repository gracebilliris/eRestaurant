          ...
          <div class="contentBx">
            <div class="formBx" style={{ fontFamily: "Times New Roman", transform: "translateY(-3%)" }}>
              ...
              <div class="inputBx">
                ...
                <Input style={{ maxWidth: "120%", fontFamily: "Times New Roman"}} role="textbox" aria-label="username" type="text" className="form-group" name="username" value={username} onChange={onChangeUsername} validations={[required]} />
              </div>
              <div class="inputBx">
                <label htmlFor="password">Password</label>
                <Input style={{fontFamily: "Times New Roman"}} type="password" role="textbox" aria-label="password" className="form-group" name="password" value={password} onChange={onChangePassword} validations={[required]} />
              </div>
              <br />
              <div>
