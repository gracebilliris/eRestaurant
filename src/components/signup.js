            ...
            <div class="contentBx">
              <div class="formBx" style={{ fontFamily: "Times New Roman", transform: "translateY(-3%)" }}>
                ...
                <div class="inputBx">
                  ...
                  <Input style={{fontFamily: "Times New Roman"}} type="text" role="textbox" aria-label="username" className="form-control" name="username" value={username} onChange={onChangeUsername} validations={[required, vusername]} />
                </div>
                <div class="inputBx">
                  <label htmlFor="email">Email</label>
                  <Input style={{fontFamily: "Times New Roman"}} type="text" role="textbox" aria-label="email" className="form-control" name="email" value={email} onChange={onChangeEmail} validations={[required, validEmail]} />
                </div>
                <div class="inputBx">
                  <label htmlFor="password">Password</label>
                  <Input style={{fontFamily: "Times New Roman"}} type="password" role="textbox" aria-label="password" className="form-control" name="password" value={password} onChange={onChangePassword} validations={[required, vpassword]} />
                </div>
                <br/>
